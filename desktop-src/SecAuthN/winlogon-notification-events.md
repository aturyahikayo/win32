...
| Event                               | Description                                                                                                                                                                                                                                                                                                         |
|-------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Lock**<br/>                 | This event occurs when a session has locked.<br/>                                                                                                                                                                                                                                                   |
...
| **StartScreenSaver/StartSSAsUser**<br/>     | This event occurs when the screen saver has started. Typically, this happens after a user has been inactive for a set period of time.<br/> Functions handling this event should not display a user interface.
**StartScreenSaver/StopSSAsUser** event notification is intended for informational purposes only.<br/> |
